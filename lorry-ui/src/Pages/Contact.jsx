      ...
      <div className="contactContainer">
        ...
        <div className="content">
          <div className="contactInfo">
            ...
            <section className="ownerInfo">
              <p className="paraContact"><FontAwesomeIcon className="icon" icon={faPhone} /> Phone:<a href="tel:+919347357455"> <span style={{color:'wheat'}}>+91 9347357455</span></a></p>
            </section>
            <section className="ownerInfo">
          ...
          <div className="mapArea">
            <a href="https://maps.app.goo.gl/YtzkGZYFKFQ9Nj7U6" target="_blank">
              <h2 style={{color:'wheat'}}>Locate Us <FontAwesomeIcon icon={faMapMarkerAlt} /></h2>
